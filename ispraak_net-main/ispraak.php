...
if ($error == 86) //completely arbitrary
{
...
echo "$ispraak_header
		...
		<form id=\"form_1007732\" class=\"ispraak_form\"  method=\"post\" action=\"review.php?mykey=$mykey&mykey2=$mykey2\">
					...
					<div class=\"form_description\">
		$ispraak_logo
			Welcome to iSpraak! Your teacher <b>($temail)</b> has shared this pronunciation activity with you. Please enter your info below and let's practice speaking!<br><br>
		</div>		$error				
			<ul >
